...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function localAIResponse(msg) {
    ...
    const KB = {
      ...
      'رجيم|دايت|وزن|تنحيف|تسمين|سعرات|Diet|حمية|تخفيف': '<p>🥗 <strong>نصائح التغذية الصحية:</strong></p><p>✅ قلّي السكر والمقليات<br>✅ زيدي الخضار والبروتين<br>✅ اشربي 8 أكواب ماء يومياً<br>✅ نامي 8 ساعات</p><p>💡 <strong>حساب السعرات:</strong> استخدمي <strong>خبيرة السعرات 🥗</strong> في قسم التغذية</p>',
      'مكياج|روج|احمر|بودرة|كونسيلر|فاونديشن|ايشادو|بلاش|ميك اب|Makeup|ميكب|كحل|آيلاينر': '<p>💄 <strong>نصائح المكياج:</strong></p><p>🔹 للبشرة الدهنية: فاونديشن مات<br>🔹 للبشرة الجافة: فاونديشن سائل بترطيب<br>🔹 للبشرة الحساسة: مكياج معدني خالٍ من العطور</p><p>⚠️ صلاحية المكياج:<br>🕐 الماسكارا: 3 أشهر<br>🕐 كريم الأساس: 6-12 شهر<br>🕐 أحمر الشفاه: 12-18 شهر</p>',
      'شعر|تساقط|قشرة|زيوت|شامبو|بلسم|Hair|تسريحة|شعرك': '<p>💇‍♀️ <strong>العناية بالشعر:</strong></p><p>🔹 شعر جاف: زيت جوز الهند + بلسم عميق<br>🔹 شعر دهني: شامبو خفيف + غسيل 2-3 مرات بالأسبوع<br>🔹 شعر تالف: بروتين + ترطيب + قص الأطراف</p><p>⚠️ غسل الشعر يومياً يزيل الزيوت الطبيعية<br>⚠️ فرك الشعر بالمنشفة يسبب تقصف</p>',
      'اظافر|أظافر|منكير|جل nail|Nail|اكريليك|باديكير': '<p>💅 <strong>العناية بالأظافر:</strong></p><p>✅ قص الأظافر باتجاه واحد<br>✅ ترطيب الجليدة يومياً (لا تقصيها!)<br>✅ خذي بريك من الجل كل 3 شهور</p><p>⚠️ البقع البيضاء: صدمة أو نقص زنك<br>⚠️ الأظافر الصفراء: استخدام مناكير بدون طبقة أساسية</p>',
      ...
      'بشرة دهنية|لمعة|زيت|مسام|حب شباب|حبوب|نياسيناميد': '<p>🧴 <strong>للبشرة الدهنية:</strong></p><p>✅ غسول ب Salicylic Acid أو Niacinamide<br>✅ مرطب خفيف (جيل أو لوشن بدون زيت)<br>✅ واقي شمس خفيف<br>⚠️ لا تستخدمي زيت جوز الهند على الوجه</p>',
      ...
      'بشرة حساسة|احمرار|حكة|تهيج|حساسية|حساسيه': '<p>🧴 <strong>للبشرة الحساسة:</strong></p><p>✅ منتجات خالية من العطور والكحول<br>✅ سيروم ب Centella Asiatica أو Panthenol<br>✅ مرطب بسيط بدون مكونات معقدة<br>⚠️ اختبر أي منتج على معصمك قبل الاستخدام</p>',
      'بشرة عادية|نورمال|مختلطة|combina': '<p>🧴 <strong>للبشرة المختلطة/العادية:</strong></p><p>✅ غسول لطيف متوازن<br>✅ مرطب متوسط الوزن<br>⚠️ اهتمي بمنطقة T-zone (الجبهة والأنف) لأنها تميل للدهنية<br>⚠️ والخدود تميل للجفاف — رطبيها أكثر</p>',
      'شيخوخة|تجاعيد|خطوط|كبر|عمر|سن': '<p>👵 <strong>مكافحة التجاعيد:</strong></p><p>✅ واقي شمس يومياً — أهم خطوة!<br>✅ ريتينول ليلياً (استشيري طبيب)<br>✅ سيروم فيتامين C صباحاً<br>✅ ترطيب عميق يومياً</p>',
      'واقي شمس|شمس|حماية|SPF|سنسكرين|صن بلوك': '<p>☀️ <strong>واقي الشمس أساسي!</strong></p><p>✅ SPF 30+ يومياً (حتى في البيت)<br>✅ جددي كل ساعتين إذا برا البيت<br>✅ الكمية: نصف ملعقة صغيرة للوجه<br>✅ اختاري واقي شمس واسع الطيف (Broad Spectrum)</p>',
      'ترطيب|مرطب|مطري|لوشن|كريم|Moisturizer|مويشر': '<p>💧 <strong>الترطيب الصح:</strong></p><p>✅ البشرة الدهنية: مرطب خفيف (جيل)<br>✅ البشرة الجافة: مرطب كثيف (سيراميد)<br>✅ البشرة العادية: مرطب متوسط<br>⚠️ المرطب يوضع على بشرة رطبة بعد الغسيل مباشرة</p>',
      'فيتامين|Vitamin|vitamin|فيتامينات|مكمل': '<p>💊 <strong>فيتامينات الجمال:</strong></p><p>✨ فيتامين C: تفتيح ونضارة<br>✨ فيتامين B5: ترطيب عميق<br>✨ فيتامين E: مضاد أكسدة<br>✨ فيتامين A (ريتينول): مضاد تجاعيد<br>✅ خذيها من مصدر طبيعي أو استشيري طبيب</p>',
      'لون بشرة|تصبغات|كلف|بقع|اسمرار|تفتيح': '<p>🎯 <strong>لتوحيد لون البشرة:</strong></p><p>✅ سيروم فيتامين C صباحاً<br>✅ Niacinamide مساءً<br>✅ واقي شمس يومياً (ضروري!)<br>✅ تقشير كيميائي لطيف مرة بالأسبوع<br>⚠️ لا تستخدمي كريمات تفتيح غير مرخصة</p>',
      'عطر|برفان|parfum|بخور|دهن عود|عطور': '<p>🌹 <strong>نصائح العطور:</strong></p><p>✅ الرشة على نقاط النبض: المعصم، الرقبة، خلف الأذن<br>✅ لا تدعكي العطر — يغير رائحته<br>✅ العطر الزهري: للنهار والربيع<br>✅ العطر الخشبي: للمساء والشتاء<br>✅ احفظي العطر في مكان بارد ومظلم</p>',
      'رياضة|تمارين|تمرين|Sport|Gym|Fitness|جيم': '<p>🏃‍♀️ <strong>الرياضة والجمال:</strong></p><p>✅ الرياضة تنعش البشرة وتنقيها<br>✅ اغسلي وجهك بعد التمرين (العرق يسد المسام)<br>✅ اشربي ماء قبل وبعد وبين<br>✅ لا تلبسي مكياج أثناء الرياضة</p>',
      'نوم|أرق|سهر|أحلام|Sleep|نومي': '<p>😴 <strong>النوم الجمالي:</strong></p><p>✅ 7-8 ساعات نوم يومياً<br>✅ النوم يقلل هرمون التوتر ويجدد البشرة<br>✅ نامي على ظهرك عشان تتجنبي تجاعيد النوم<br>✅ وسادة حرير أو قطن ناعم تحمي شعرك وبشرتك</p>',
      'ماء|شرب|شربي|عطش|Hydration|Water|ماي': '<p>💧 <strong>الماء وجمالك:</strong></p><p>✅ 8 أكواب ماء يومياً (حوالي 2 لتر)<br>✅ الماء ينقي البشرة ويقلل الانتفاخ<br>✅ زيدي الكمية في الأيام الحارة أو الرياضة<br>✅ الخيار والبطيخ والخس فيه ماء طبيعي</p>',
      'حامل|حمل|أم|مرضع|Pregnancy|حوامل': '<p>🤰 <strong>العناية في الحمل والرضاعة:</strong></p><p>⚠️ ممنوع: ريتينول، هيدروكينون، حمض الساليسيليك بتركيز عالي<br>✅ آمن: فيتامين C، حمض الهيالورونيك، نيازيناميد<br>✅ استشيري طبيبتك قبل أي منتج جديد</p>',
      'مراهقة|عمر|سن|صغيره|بنت|مراهقات|Teen|صبايا': '<p>🌸 <strong>نصائح للمراهقات:</strong></p><p>✅ روتين بسيط: غسول + مرطب + واقي شمس<br>✅ لا تستخدمي منتجات كبار — بشرتك صغيرة وتحتاج لطافة<br>✅ نظفي وجهك صباح ومساء<br>✅ لا تعصري الحبوب — تسبب ندبات<br>✅ رطبي شفايفك ببلسم مرطب</p>',
      'شعر كيرلي|كيرلي|Curly|curly|مجعد|تجعيدات|ويفي': '<p>🌀 <strong>العناية بالشعر الكيرلي والمموج:</strong></p><p>✅ لا تمشطيه وهو ناشف — مشطي وأنتِ في الحمام والبلسم<br>✅ استخدمي كريم تسريح أو جيل خفيف<br>✅ مشط واسع الأسنان — مشط صغير يقطع الشعر<br>✅ زيت جوز الهند أو زبدة الشيا للترطيب</p>',
      'شعر مصبوغ|صبغ|صبغة|لون شعر|Hair Color|سحب لون': '<p>🎨 <strong>العناية بالشعر المصبوغ:</strong></p><p>✅ استخدمي شامبو وبلسم للشعر المصبوغ<br>✅ قللي غسيل الشعر — يحافظ على اللون<br>✅ زيت الأرغان يغذي ويحمي اللون<br>✅ بروتين مرة بالأسبوع لتعويض التلف</p>',
      'قشرة الرأس|قشرة|حكة رأس|Dandruff|قشره': '<p>❄️ <strong>القشرة:</strong></p><p>✅ شامبو ضد القشرة يحتوي Zinc Pyrithione أو Ketoconazole<br>✅ لا تحكّي رأسك بقوة<br>✅ قللي من الزيوت على فروة الرأس<br>✅ إذا القشرة مستمرة — زوري طبيب جلدية</p>',
      'شعر وجه|شوارب|وجه شعر|حلاقة|إزالة|شعر زائد|شعرانه': '<p>🪒 <strong>إزالة شعر الوجه:</strong></p><p>✅ الخيط: أنظف وأفضل للبشرة<br>✅ الشفرة المخصصة للوجه: لطيفة وآمنة<br>✅ كريم إزالة الشعر: اختاري النوع المخصص للوجه<br>⚠️ لا تستخدمي موس الحلاقة العادي — يسبب خشونة</p>',
      'جلدية|طبيب جلدية|دكتور جلدية|استشارة طبية|دكتورة': '<p>👩‍⚕️ <strong>استشارة طبية:</strong></p><p>⚠️ أنا مساعد معلومات وليس طبيبة. إذا عندك:<br>• حساسية شديدة<br>• طفح جلدي<br>• حب شباب ملتهب<br>• بقع غريبة<br>👉 الأفضل تزوري طبيبة جلدية 💜</p>',
      'تقشير|سكراب|مقشر|Exfoliat|جلد ميت': '<p>🧽 <strong>التقشير الصح:</strong></p><p>✅ البشرة الدهنية: 2-3 مرات بالأسبوع<br>✅ البشرة الجافة/الحساسة: مرة بالأسبوع<br>✅ استخدمي مقشر كيميائي لطيف (AHA/BHA)<br>🚫 لا تستخدمي سكراب خشن (يسبب جروح)</p>',
      'عيون|هالات|انتفاخ|تحت العين|كحه|عين': '<p>👁️ <strong>العناية بمنطقة العين:</strong></p><p>✅ كريم عيون يحتوي كافيين (للانتفاخ)<br>✅ فيتامين C أو ريتينول (للهالات)<br>✅ دلكي بلطف — الجلد هنا رقيق جداً<br>✅ كمادات باردة صباحاً تزيل الانتفاخ</p>',
      'شفايف|شفاه|جفاف شفايف|تشقق|Lips|lip': '<p>💋 <strong>العناية بالشفايف:</strong></p><p>✅ مرطب شفاه يومياً (مع SPF للنهار)<br>✅ سكراب شفايف: سكر + عسل مرة بالأسبوع<br>✅ اشربي ماء — الجفاف يسبب تشقق<br>⚠️ لا تلعقي شفايفك — اللعاب يزيد الجفاف</p>',
      'يدين|أيدي|جفاف يدين|كريم يد|Hands': '<p>🤲 <strong>العناية باليدين:</strong></p><p>✅ كريم يدين بعد كل غسيل<br>✅ قفازات عند التنظيف أو غسيل الصحون<br>✅ كريم واقي شمس للأيدي (تتعرّض للشمس دايم)<br>✅ سكراب يدين مرة بالأسبوع</p>',
      'جسم|بودي|لوشن جسم|سيلوليت|ترهلات|زيادة|جسمي|جسمك': '<p>🧴 <strong>العناية بالجسم:</strong></p><p>✅ لوشن مرطب يومياً (زيت جوز الهند أو زبدة شيا)<br>✅ سكراب للجسم مرة بالأسبوع<br>✅ الرياضة تقلل السيلوليت والترهلات<br>✅ اشربي ماء — يشد البشرة</p>',
      'سبا|حمام مغربي|حمام|بخار|مساج|Steam|Spa': '<p>🛁 <strong>سبا منزلي:</strong></p><p>✅ ماء دافئ (مو حار — يحرق)<br>✅ ملح إبسوم + زيت عطري في الحمام<br>✅ ماسك وجه طبيعي أثناء البخار<br>✅ زيت جوز الهند لتدليك الجسم</p>',
      'صيف|حر|شمس|اجازه|سفر|ساحلي|شاطئ': '<p>☀️ <strong>العناية في الصيف:</strong></p><p>✅ واقي شمس SPF 50+ على الشاطئ<br>✅ جددي كل ساعتين<br>✅ سيروم فيتامين C يحمي من التصبغات<br>✅ مرطب خفيف (جيل) للبشرة<br>✅ قبعة ونظارة شمس</p>',
      'شتاء|برد|جاف|شتوي|Cold|Winter': '<p>❄️ <strong>العناية في الشتاء:</strong></p><p>✅ مرطب كثيف (كريم بالزبدة أو السيراميد)<br>✅ مرطب شفاه أقوى<br>✅ لا تستخدمي ماء حار جداً للاستحمام<br>✅ زيت جوز الهند أو زيت اللوز للترطيب العميق</p>',
      'رجيم|ماء|دايت|اكل صحي|أكل|غذا|سناك|فطور|غداء|عشاء': '<p>🥗 <strong>أكل صحي للجمال:</strong></p><p>✅ خضار وفواكه ملونة (مضادات أكسدة)<br>✅ بروتين (دجاج، سمك، بيض، فول)<br>✅ دهون صحية (أفوكادو، مكسرات، زيت زيتون)<br>🚫 قلّي سكر ومقليات ووجبات سريعة</p>',
      'ماسك|قناع|Mask|ماسكات|وجه ماسك': '<p>🎭 <strong>الماسكات الطبيعية:</strong></p><p>🧴 للبشرة الدهنية: طمي + ماء ورد<br>🧴 للبشرة الجافة: عسل + زبادي + أفوكادو<br>🧴 للبشرة الحساسة: شوفان + حليب<br>⏱️ 10-15 دقيقة وشطف بماء فاتر</p>',
      'سيروم|Serum|مصل': '<p>🧪 <strong>السيرومات:</strong></p><p>✅ فيتامين C: صباحاً — نضارة وتفتيح<br>✅ هيالورونيك أسيد: ترطيب عميق<br>✅ نياسيناميد: مسام ودهون وتصبغات<br>✅ ريتينول: ليلياً — تجاعيد فقط بعد 25<br>⚠️ سيروم واحد يكفي — لا تكثري</p>',
      'micro|Microneedling|ديرمارولر|ديرما بن|سنفره': '<p>⚠️ <strong>تحذير من DERMAPEN/Microneedling</strong></p><p>🚫 خطيرة جداً في البيت!<br>🚫 تسبب تندب والتهابات إذا مو معقمة<br>✅ Only at a dermatologist clinic<br>❌ لا تشتريها من النت وتستخدمينها بنفسك</p>',
      'بوتوكس|Botox|فيلر|بلازما|حقن': '<p>⚠️ <strong>الحقن التجميلية:</strong></p><p>✅ فقط عند طبيبة جلدية مؤهلة<br>✅ البوتوكس: لتجاعيد الجبهة والزوايا<br>✅ الفيلر: لنفخ الخدود والشفايف<br>🚫 لا تروحي لمراكز تجميل غير مرخصة<br>⚠️ تحت 25 سنة مو محتاجة بوتوكس!</p>',
      'حساسية الشمس|شمس|طفح شمسي|حروق شمس': '<p>☀️ <strong>حروق الشمس:</strong></p><p>✅ كمادات باردة فوراً<br>✅ جل ألوفيرا (صبار) طبيعي<br>✅ مرطب غني (لا تستخدمي زبدة)<br>✅ اشربي ماء كثير<br>🚫 لا تلمسي البثور — تترك آثار<br>⚠️ إذا الحرق شديد — راجعي طبيبة</p>',
      'حبوب الشباب|حب|بثور|عروسة|خراج|حبة': '<p>🔴 <strong>التعامل مع الحبوب:</strong></p><p>✅ غسول ب Salicylic Acid أو Benzoyl Peroxide<br>✅ لا تعصري الحبة — تسبب ندبة<br>✅ لصقة حبوب (Hydrocolloid) على الحبة الكبيرة<br>✅ كريم بالنياسيناميد يخفف الالتهاب<br>⚠️ إذا الحبوب كثيرة — استشيري طبيبة</p>',
      'الندبات|ندبات|آثار حبوب|فراغات|mark|Scar': '<p>🎯 <strong>للتخلص من آثار الحبوب:</strong></p><p>✅ سيروم فيتامين C + Niacinamide<br>✅ واقي شمس يومياً ضروري جداً<br>✅ تقشير كيميائي (AHA) مرتين بالأسبوع<br>✅ سيروم بالريتينول مساءً<br>⏱️ تحتاج صبر — 3-6 شهور عشان النتيجة</p>',
      'حناء|Henna|حنة|حنا': '<p>🌿 <strong>الحناء للشعر:</strong></p><p>✅ حناء طبيعية تغذي الشعر وتلمعه<br>✅ تزيد كثافة الشعر ولمعانه<br>⚠️ الحناء الحمراء (طبيعية) — آمنة<br>⚠️ الحناء السوداء تحتوي مواد كيميائية — احذري!</p>',
      'زيت جوز الهند|coconut|جوز الهند': '<p>🥥 <strong>زيت جوز الهند:</strong></p><p>✅ للشعر: ماسك قبل الاستحمام — ترطيب عميق<br>✅ للجسم: مرطب طبيعي بعد الحمام<br>✅ لإزالة المكياج: مزيت طبيعي لطيف<br>🚫 للوجه الدهني: لا — يسد المسام</p>',
      'ألوفيرا|صبار|Aloe|جل الصبار': '<p>🌵 <strong>جل الصبار (ألوفيرا):</strong></p><p>✅ للحروق والتهيج: بارد ومنعش<br>✅ للترطيب: خفيف ومناسب للبشرة الدهنية<br>✅ للشعر: ماسك بعد الشامبو يلمع الشعر<br>✅ طبيعي وآمن لجميع أنواع البشرة</p>',
    };
...
// =============================================
// MAKEUP EXPERT (خبيرة المكياج التفاعلية)
// =============================================
const MAKEUP_KNOWLEDGE = {
  'تحضير البشرة': 'تحضير البشرة نصف سرّ اللوك 💎\n\nالخطوات: غسول ← تونر ← سيروم ← مرطب ← واقي شمس ← برايمر.\n⏳ انتظري دقيقة بين كل طبقة عشان ما يتكتّل المكياج.\n\nالبرايمر حسب مشكلتك:\n• دهنية/مسام واسعة ← ماتّفايينغ\n• جافة ← مرطّب/مضيء\n• توحيد لون ← ملون\n\n💡 نصيحة: البشرة المبللة شوي تعطي مكياج أدمج وأجمل.',

  'فاونديشن': 'اختيار الفاونديشن المناسب 🎯\n\n1️⃣ الأندرتون:\n• عروق خضراء = دافئ ← فاونديشن أصفر/ذهبي\n• عروق زرقاء/بنفسجية = بارد ← فاونديشن وردي\n• مختلط = محايد\n\n2️⃣ جربي على خط الفك مو على اليد، وبإضاءة نهار.\n\n3️⃣ الدرجة = لون بشرتك، والأندرتون = نغمتها. الاثنين لازم يطابقون.\n\n4️⃣ أنواع التغطية:\n• شفافة ← متوسطة ← كاملة. ابدئي بالأقل وزيدي.\n\n5️⃣ اللمسة النهائية:\n• مات ← دهنية • ديوي ← جافة • ساتان ← الكل\n\n💡 سرّ: وزعي بحركات نازلة لتحت عشان ما تبرز الوبرة.',

  'كونسيلر': 'الكونسيلر الصح 👁️\n\n• تحت العين: طبقيه على شكل مثلث مقلوب مو بس خط — يمنح شد وإشراقة.\n• للهالات: صححي اللون أول (برتقالي/خوخي للزرقاء، أصفر للبنفسجية).\n• للتفتيح: أفتح بدرجة أو درجتين فقط.\n• للحبوب: نفس لون بشرتك تماماً.\n\n⚠️ لا تفرطين في الكونسيلر الفاتح — يطلع «راكون مقلوب».\n💡 ثبتي بودرة خفيفة عشان ما يتجمع في الخطوط.',

  'كونتور': 'الفرق بين الكونتور والبرونزر 🎭\n\nالكونتور = ظل (درجات باردة رمادية) يجوّف وينحت.\nالبرونزر = دفء وشمس (درجات دافئة).\n\nأماكن الكونتور:\n• تحت عظمة الخد\n• جانبي الأنف\n• خط الفك\n• الصدغ عند الشعر\n\nالبلاشر حسب شكل الوجه:\n• دائري: مائل للصدغ (يطوّل)\n• مربع: على التفاحة بدوائر (ينعّم الزوايا)\n• مستطيل: أفقي (يقصّر)\n• قلب: على التفاحة مائل للأسفل\n• بيضاوي: على التفاحة بحرية\n\nالهايلايتر: أعلى الخد، عظمة الحاجب، زاوية العين الداخلية، قوس كيوبيد.\n\n📌 القاعدة: كريم للمسة طبيعية، بودرة للثبات.',

  'العيون': 'مكياج العيون حسب شكلها 👁️\n\nالأساس الثابت:\nبرايمر → لون انتقالي في الثنية → لون أغمق في الزاوية الخارجية → لون لامع على الجفن والزاوية الداخلية → دمج بفرشاة نظيفة.\n\nحسب شكل العين:\n• مغطّاة الجفن: ظل فوق الثنية الطبيعية وعينك مفتوحة\n• متجهة للأسفل: آيلاينر مجنّح للأعلى\n• متقاربة: فاتح في الداخل + غامق في الخارج\n• أحادية الجفن: تدرج عمودي من الرمش للأعلى\n• غائرة: افتحي الجفن وتجنّبي الغامق في الثنية\n• جاحظة: ظلال مطفية متوسطة وقلّلي اللمعة',

  'آيلاينر': 'الآيلاينر حسب شكل عينك ✏️\n\n• لوزية: آيلاينر ممدود (كلاسيكي)\n• مستديرة: جناح مرفوع للأعلى (Fox Eye)\n• مبططة: خط رفيع على الجفن فقط\n• صغيرة: كحل نيود/أبيض في الخط المائي السفلي يكبّرها\n• متقاربة: آيلاينر رفيع من الداخل ويثخن للخارج\n• واسعة: آيلاينر سميك يغطي الجفن كامل\n\n💡 سر تكبير العين: كحل نيود في المايون لاين.\n\nانواع الآيلاينر:\n• مجنّح (كلاسيكي)\n• فوكس آي (ممدود)\n• بوبي آي (دائري كوري)\n• تايتلاين (خط مائي علوي كثيف للرموش)',

  'ماسكارا': 'الماسكارا ورموش أحلام 👁️\n\n• حرّكي الفرشاة بتعرّج من الجذر للأطراف.\n• لا تضخّين الفرشاة في الأنبوب (يجففها).\n• مجعّدة = طول • كثيفة = حجم • مقاومة للماء = رطوبة ومناسبات.\n\nالرموش الصناعية:\n• ستريب (كامل) • فردي (طبيعي) • مغناطيسي (سهل)\n\n⚠️ الماسكارا تنتهي بعد 3 شهور — لا تستخدمينها أقدم.\n💡 استخدمي ماسكارا مقاومة للماء في المناسبات فقط، لأنها تجفف الرموش.',

  'حواجب': 'الحواجب المثالية ✨\n\nتقنية القياس (Mapping):\n• البداية = خط الأنف\n• القوس = الأنف عبر بؤبؤ العين\n• النهاية = الأنف لزاوية العين الخارجية\n\nاملئي الفراغات بضربات خفيفة تحاكي الشعر (مش تلوين كتلة).\nمشّطي للأعلى بالفرشاة.\n\nالأدوات:\n• قلم ← دقة • بوميد ← ثبات • بودرة ← نعومة • جل ← تثبيت\n\n⚠️ لا تبالغي في النتف — اتبعي الشكل الطبيعي.',

  'شفاه': 'الشفاه الجذابة 💋\n\nحضّري الشفاه: تقشير خفيف + بلسم.\nحدّدي بمحايد للتعريف.\nلتكبير الشفاه: تجاوزي الخط بملّيمتر واحد عند القوس والمنتصف فقط.\n\nخدعة الثبات:\nحدّدي ← لوني ← ربّتي بمنديل ← بودرة شفافة ← طبقة ثانية.\n\nالأومبري: محيط أغمق + منتصف أفتح + ملمّع.\n\nاختيار اللون حسب الأندرتون:\n• دافئ ← خوخي/طوبي • بارد ← وردي/توتي\n\n⚠️ الأحمر البارد (Blue Red) يبيّض الأسنان!',

  'تثبيت': 'سر المكياج اللي يدوم طول اليوم 🔒\n\n• البودرة الشفافة: سائبة للبيكينغ (تحت العين)، مضغوطة للتعديلات.\n• البيكينغ: بودرة كثيفة 5-10 دقايق ثم تُكنَس = تثبيت + إشراقة.\n• السيتينغ سبراي: مات للدهنية، ديوي للجافة.\n\n💡 خدعة احترافية:\nرشّي السبراي بين الطبقات (بعد كريم + قبل بودرة + بعد النهاية) = مكياج ملحّف يدوم.\n\n⚠️ لا تفرطين في البودرة — البودرة الزائدة = مكياج كيكي.',

  'بشرة دهنية': 'للبشرة الدهنية 🧴\n\n• غسول + تونر قبل المكياج.\n• برايمر مات يملأ المسام.\n• فاونديشن مات خالي من الزيوت.\n• تقنية البيك (بودرة كثيفة تكنسينها).\n• ورق تنشيف طول اليوم.\n• بخاخ تثبيت مات.\n\n💡 بدل بودرة كثيرة → خففي طبقة الفاونديشن وزيدي البودرة الخفيفة.',

  'بشرة جافة': 'للبشرة الجافة 💧\n\n• رطبي 10-15 دقيقة قبل المكياج (كريم غني + هيالورونيك).\n• برايمر مرطب أو مضيء.\n• فاونديشن سائل ديوي (مش مات أبداً).\n• إسفنجة مبللة — ربتي لا تمسحين.\n• لا بودرة كثيرة — فقط T-zone خفيفة.\n• بخاخ تثبيت مرطب.\n\n💡 لو بشرتك قشرت → مرطب ملون أحسن من فاونديشن ثقيل.',

  'مناسبة': 'المكياج حسب المناسبة 🎯\n\n• يومي/نو ميك أب: تينتد + كونسيلر خفيف + ماسكارا + بلاشر كريمي + ملمّع.\n• دوام/جامعة: متوازن، ألوان محايدة، ثابت.\n• سهرة: سموكي + جليتير + رموش + كونتور.\n• زواج/عروس: ثابت وواتربروف، تجنّبي SPF عالي (فلاش باك).\n\nللتصوير:\n• مات • تحديد أقوى • بدون SPF.',

  'أخطاء': 'أشهر أخطاء المكياج ⚠️\n\n1. درجة فاونديشن غلط (جربي على الفك).\n2. عدم الدمج — خطوط حادة خصوصاً الكونتور والآيشادو.\n3. الإفراط في المنتج = إطلالة «كيكية».\n4. تجاهل تحضير البشرة.\n5. كونسيلر أفتح من اللازم (راكون مقلوب).\n6. ماسكارا متراكمة (أرجل العنكبوت).\n7. حواجب مرسومة بقسوة.\n8. تجاهل الرقبة (فرق لون واضح).\n9. استخدام منتجات منتهية.\n10. النوم بالمكياج.\n\n💡 الأقل أكثر — ابدئي بطبقات رقيقة وابني.',

  'بشرة ناضجة': 'للبشرة الناضجة 🌸\n\n• الترطيب أولوية.\n• كريمات بدل البودرة.\n• تجنّبي المات الثقيل.\n• تجنّبي اللمعة في التجاعيد.\n• ركّزي على الشد والحواجب المحدّدة.\n\n💡 أقل من المنتج أكثر = نتيجة أفضل.',

  'الوان': 'كيف تختارين ألوان مكياجك 🎨\n\nظلال العيون حسب لون العين:\n• عيون بنية: ذهبي، بنفسجي، أخضر زيتوني\n• عيون خضراء: خوخي، وردي، بني\n• عيون زرقاء: برونزي، خوخي، بني دافئ\n• عيون عسلية: بنفسجي، ذهبي، وردي\n\nالروج:\n• بشرة فاتحة: وردي + خوخي + بيري\n• بشرة حنطية: تيراكوتا + كراميل + أحمر دافئ\n• بشرة داكنة: أحمر غامق + برقوقي + بني\n\nقاعدة: عيون داكن ← روج هادي | عيون هادية ← روج جريء',

  'ادوات': 'أدوات المكياج الأساسية 🧰\n\nالفرش الأساسية:\n• فاونديشن • كونسيلر • بودرة • بلاشر • كونتور • فان للهايلايتر\n• بلندنغ • فلات شادر • كريز • مشطّحة • سبولي • شفاه\n\nالصناعية ← للكريم والسائل.\nالطبيعية ← للبودرة.\n\nنظّفي الفرش أسبوعيًا.\nالبيوتي بلندر يُغسل مبلّل ويُستبدل كل 3 شهور.\n\n💡 رطّبي الإسفنجة — تعطي لمسة طبيعية مدمجة.',

  'صلاحية': 'صلاحية المكياج ⏳\n\n• الماسكارا: 3 شهور\n• الفاونديشن السائل: 6-12 شهر\n• البودرة وأحمر الشفاه: سنة-سنتين\n• البيوتي بلندر: 3 شهور\n\n⚠️ لا تستخدمين مكياج منتهي — يسبب حساسية وبكتيريا.\nانتبهي لرمز PAO (المرطبان المفتوح) على العبوة.\n\n💡 النوم بالمكياج = مسام مسدودة وشيخوخة مبكرة.',

  'حساسة': 'للبشرة الحساسة 🌿\n\n• مكياج معدني خالٍ من العطور.\n• تجنّبي البارابين والفثالات.\n• اختبري أي منتج على منطقة صغيرة أولاً.\n• لا تتشاركي المكياج (خاصة العين والشفاه).\n\n⚠️ المواد اللي تتجنبينها:\n• كحول • عطور صناعية • بارابين\n\n💡 مكياج معدني (Mineral Makeup) أفضل خيار للبشرة الحساسة.',
};

window.makeupSend = function() {
  const input = document.getElementById('makeupInput');
  const msg = input.value.trim();
  if (!msg) return;
  input.value = '';
  const box = document.getElementById('makeupChatBox');

  const userDiv = document.createElement('div');
  userDiv.className = 'makeup-msg makeup-msg-user';
  userDiv.innerHTML = '<div class="makeup-msg-header">👩 أنتِ</div>' + msg.replace(/</g,'&lt;');
  box.appendChild(userDiv);
  box.scrollTop = box.scrollHeight;

  const loadDiv = document.createElement('div');
  loadDiv.className = 'makeup-msg makeup-msg-loading';
  loadDiv.innerHTML = '💄 جاري تحليل طلبك...';
  box.appendChild(loadDiv);
  box.scrollTop = box.scrollHeight;
  ...
  setTimeout(() => {
    loadDiv.remove();
    const botDiv = document.createElement('div');
    botDiv.className = 'makeup-msg makeup-msg-bot';
    botDiv.innerHTML = '<div class="makeup-msg-header">💄 خبيرة المكياج</div>' + makeupResponse(msg);
    box.appendChild(botDiv);
    box.scrollTop = box.scrollHeight;
  }, 800);
};

window.makeupQuick = function(q) {
  document.getElementById('makeupInput').value = q;
  makeupSend();
};

function makeupResponse(msg) {
  const q = msg.toLowerCase();

  // تحية
  if (q.includes('هلا') || q.includes('مرحبا') || q.includes('السلام') || q.includes('hi') || q.includes('hello')) {
    return '<p>هلا فيكِ 💗 أنا خبيرتك في المكياج! اسأليني عن أي شيء — نوع بشرتك، شكل عيونك، مناسبتك — وأعطيك نصائح مخصصة 🎯</p>';
  }
  if (q.includes('شكرا') || q.includes('thank')) return '<p>العفو 💗 دائماً هنا لمساعدتك! 🌸</p>';

  // البحث في قاعدة المعرفة
  for (const [key, val] of Object.entries(MAKEUP_KNOWLEDGE)) {
    if (q.includes(key)) {
      return '<p>' + val.replace(/\n/g, '<br>') + '</p><p style="margin-top:0.8rem;font-size:0.8rem;color:var(--text-light)">💡 عندك سؤال ثاني؟ أنا هنا 🎯</p>';
    }
  }

  // الكشف الذكي عن الكلمات المفتاحية
  if (q.includes('دهني') || q.includes('لمعة') || q.includes('مات') || q.includes('زيت')) {
    return '<p>' + MAKEUP_KNOWLEDGE['بشرة دهنية'].replace(/\n/g, '<br>') + '</p><p style="margin-top:0.8rem;font-size:0.8rem;color:var(--text-light)">💡 تبين تفاصيل أكثر عن شيء معين؟</p>';
  }
  if (q.includes('جاف') || q.includes('تقشر') || q.includes('ترطيب')) {
    return '<p>' + MAKEUP_KNOWLEDGE['بشرة جافة'].replace(/\n/g, '<br>') + '</p><p style="margin-top:0.8rem;font-size:0.8rem;color:var(--text-light)">💡 تبين تفاصيل أكثر عن شيء معين؟</p>';
  }
  if (q.includes('داكن') || q.includes('سهرة') || q.includes('حفلة') || q.includes('زواج') || q.includes('عروس') || q.includes('غلام')) {
    return '<p>' + MAKEUP_KNOWLEDGE['مناسبة'].replace(/\n/g, '<br>') + '</p><p style="margin-top:0.8rem;font-size:0.8rem;color:var(--text-light)">💡 تبين تفاصيل أكثر عن لوك معين؟</p>';
  }
  if (q.includes('مدرسة') || q.includes('جامعة') || q.includes('دوام') || q.includes('عمل') || q.includes('نهاري')) {
    return '<p><strong>مكياج يومي/دوام 🌸</strong><br><br>📍 <strong>الخطوات:</strong><br>• BB Cream أو تينتد مويسشرايزر<br>• كونسيلر خفيف للهالات<br>• ماسكرا فقط (لا آيلاينر)<br>• بلاش كريمي خفيف<br>• مرطب شفاه ملون<br><br>💡 <strong>نصيحة:</strong> خففي طبقات المكياج عشان يدوم بالدوام ولا يطفي على إطلالتك الطبيعية. ركزي على البشرة الصافية مو على الألوان القوية.</p><p style="margin-top:0.8rem;font-size:0.8rem;color:var(--text-light)">💡 تبين مكياج لمناسبة ثانية؟</p>';
  }
  if (q.includes('لون') || q.includes('درجة') || q.includes('ألوان') || q.includes('اختيار') && (q.includes('روج') || q.includes('شفايف') || q.includes('ظلال') || q.includes('عيون'))) {
    return '<p>' + MAKEUP_KNOWLEDGE['الوان'].replace(/\n/g, '<br>') + '</p><p style="margin-top:0.8rem;font-size:0.8rem;color:var(--text-light)">💡 عندك سؤال ثاني؟</p>';
  }

  // العام — رد ذكي يعرف بنفسه
  return '<p><strong>خبيرة المكياج 💄</strong></p><p>تقدرين تسألينني عن:</p><p>• 🧴 <strong>فاونديشن</strong> يناسب بشرتك<br>• 👁️ <strong>مكياج عيون</strong> حسب شكلها<br>• 🎭 <strong>كونتور وهايلايتر</strong><br>• 💋 <strong>الروج</strong> المناسب لكِ<br>• 🔒 <strong>تثبيت المكياج</strong><br>• ⚠️ <strong>أخطاء</strong> شائعة<br>• 🌿 للبشرة الدهنية/الجافة/الحساسة<br>• 🎨 اختيار الألوان</p><p>قوليلي شنو تبين بالضبط 🎯</p>';
}
